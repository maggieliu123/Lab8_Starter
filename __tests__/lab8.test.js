describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    await button.click();
    var buttonInnerText = await button.getProperty('innerText');
    var textValue = await buttonInnerText.jsonValue();
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    const getCartCount = await page.$('#cart-count');
    const cartCountInnerText = await getCartCount.getProperty('innerText')
    const cartCountJson = await cartCountInnerText.jsonValue();
